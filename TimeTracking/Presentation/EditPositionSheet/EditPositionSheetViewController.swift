...
class EditPositionSheetViewController: UIViewController {

    @IBOutlet weak var dismissButton: UIBarButtonItem!
    @IBOutlet weak var saveButton: UIBarButtonItem!
    @IBOutlet weak var sheetView: SpreadsheetView!

    var editPositionSheetViewModel: EditPositionSheetViewModel!
    ...
    func bindViewModel() {
        let input = EditPositionSheetViewModel.Input(loadTrigger: Driver.just(()),
        ...
        let output = editPositionSheetViewModel.transform(input: input)
...
extension EditPositionSheetViewController: AddButtonCellDelegate {
    func addColumn() {
...
extension EditPositionSheetViewController: HeaderCellDelegate {
...
extension EditPositionSheetViewController: HeaderSettingDelegate {
...
extension EditPositionSheetViewController: DataCellDelegate {
...
extension EditPositionSheetViewController: NoteDialogViewCellDelegate {
...
extension EditPositionSheetViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
